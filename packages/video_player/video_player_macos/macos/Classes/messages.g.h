...
/// The codec used by FLTVideoPlayerMacOsApi.
NSObject<FlutterMessageCodec> *FLTVideoPlayerMacOsApiGetCodec(void);

@protocol FLTVideoPlayerMacOsApi
...
extern void FLTVideoPlayerMacOsApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTVideoPlayerMacOsApi> *_Nullable api);
